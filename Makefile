...
all: main.o string_utils.o echo.o cd.o jobs.o ls.o print_table.o path_utils.o
	$(CC) $(CFLAGS) main.o string_utils.o echo.o cd.o jobs.o ls.o print_table.o path_utils.o -o bush
